! function(t, e) {
  ...
  return function(t) {
    ...
    function s(t) {
      ...
      var n = e;
      e.attachShadow && (y("Using shadow DOM."), n = e.attachShadow({
        mode: "open"
      }));
    ...
    var h = n(1),
      v = n(5),
      m = "undefined" == typeof Promise ? h.Promise : Promise,
      y = function(t) {},
      w = !0,
      b = function() {
        (console.warn || console.log).call(arguments)
      },
      g = b.bind(console, "[clipboard-polyfill]"),
      _ = "text/plain",
      T = function() {
        function t() {}
    ...
    var o = ["text/plain", "text/html"],
      ...
      u = i.bind(console, "[clipboard-polyfill]"),
      s = !0;
